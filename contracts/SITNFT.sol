        ...
        return
            string(
                abi.encodePacked(
                    ...
                    attributes[_tokenId].moduleCode,
                    "</text>",
                    '<text x="15" y="100" class="medium">Trimester> ',
                    attributes[_tokenId].trimester,
                    "</text>",
